...
export default class RegistrationForm extends Component {
    ...
    return (
         <div>
           <Nav />  
            <form className="registration" onSubmit={this.handleRegistrationSubmit}>
                ...
                <input type="email" className="registration__control" name="email" id="email" onChange={e => this.updateEmail(e.target.value)} defaultValue="myaddress@email.com"/>
                ...
                <div className="vote-link-button-group">
                  <button type="reset" className="vote-link"> Cancel </button>
                  <button type="submit" className="vote-link" disabled={  this.validateEmail() && this.validatePassword() && this.validateRepeatPassword() } > Save </button>
                </div>
              </form>
        </div>
    )}
